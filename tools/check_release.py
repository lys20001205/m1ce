...
SUITES={'':53,'v11':41,'audio':12,'combat':17,'depot':11,'dev':19,'enemies':11,'life':11,'prep':12,'release':21,'train':10,'ship':11,'qa':42,'muzzle':39,'lifecycle':34}
...
def inspect(art=ART):
    ...
    tap={}
    for name,minimum in [('unit.txt',235),('model-tests.txt',6)]:
        try:
