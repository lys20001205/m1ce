...
function save(group,name){fs.writeFileSync(`${out}/assets/${name}.json`,JSON.stringify(group.toJSON()));}
...
shell.add(merge(body,'Hull'));const roof=new T.Group();box(roof,0,4.03,-.46,8,.18,2.12,0x718b97);box(roof,0,4.17,-1.44,8,.16,.12,0xeac06f);shell.add(merge(roof,'RoofCutaway'));
